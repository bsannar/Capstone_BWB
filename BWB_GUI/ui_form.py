...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnViewAircraftTaw = QToolButton(self.tbTW)
        self.btnViewAircraftTaw.setObjectName(u"btnViewAircraftTaw")

        self.gridLayout_5.addWidget(self.btnViewAircraftTaw, 1, 0, 1, 1)

        self.ddChooseAircraft = QToolButton(self.tbTW)
        self.ddChooseAircraft.setObjectName(u"ddChooseAircraft")

        self.gridLayout_5.addWidget(self.ddChooseAircraft, 0, 0, 1, 1)
